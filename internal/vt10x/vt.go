...
// WithHistoryLimit caps how many scrolled-off primary-screen lines are
// kept for scrollback (default 10000 if unset or <= 0).
func WithHistoryLimit(n int) TerminalOption {
	return func(info *TerminalInfo) {
		info.historyLimit = n
	}
}
